...
export const keyboardLetters = [
    [{letter: 'Q', isDisabled: false},{letter: 'W', isDisabled: false},{letter: 'E', isDisabled: false},{letter: 'R', isDisabled: false},{letter: 'T', isDisabled: false},{letter: 'Y', isDisabled: false},{letter: 'U', isDisabled: false},{letter: 'I', isDisabled: false},{letter: 'O', isDisabled: false},{letter: 'P', isDisabled: false}],
    [{letter: 'A', isDisabled: false},{letter: 'S', isDisabled: false},{letter: 'D', isDisabled: false},{letter: 'F', isDisabled: false},{letter: 'G', isDisabled: false},{letter: 'H', isDisabled: false},{letter: 'J', isDisabled: false},{letter: 'K', isDisabled: false},{letter: 'L', isDisabled: false}],
    [{letter: 'Z', isDisabled: false},{letter: 'X', isDisabled: false},{letter: 'C', isDisabled: false},{letter: 'V', isDisabled: false},{letter: 'B', isDisabled: false},{letter: 'N', isDisabled: false},{letter: 'M', isDisabled: false}]];
